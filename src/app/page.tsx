  ...
  return (
    <div className="min-h-screen bg-primary text-blue-100">
        ...
        <div className="container relative z-20 px-4 md:px-6">
          <StaggeredReveal>
            <div className="max-w-4xl mx-auto text-center">
              <p className="text-blue-300 tracking-wider uppercase mb-3 opacity-90">
                EST. 2014
              </p>
              <h1 className="text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-bold tracking-tight mb-6 leading-tight">
                <span className="shine-text">Transforming</span>
                ...
                <span className="shine-text">with Premium Glass</span>
              </h1>
      ...
      <section className="py-10 sm:py-12 md:py-16 relative overflow-hidden">
        {/* Background */}
        <div className="absolute inset-0 bg-gradient-to-br from-blue-900/20 via-black/90 to-black/80"></div>

        <div className="container mx-auto px-4 relative z-10">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
            {/* Box 1 */}
            <StaggeredReveal delay={0}>
              <div className="h-full bg-blue-900/30 border border-blue-500/20 rounded-lg p-4 sm:p-6 backdrop-blur-sm transition-all duration-300 hover:scale-[1.03] hover:bg-blue-800/40 hover:border-blue-400/40 hover:shadow-lg hover:shadow-blue-500/20 group flex flex-col">
                <div>
                  ...
                  <p className="text-sm sm:text-base text-blue-100">
                    Engineered systems. Industry-grade finishes.
                  </p>
                </div>
              </div>
            </StaggeredReveal>
            ...
            <StaggeredReveal delay={120}>
              <div className="h-full bg-blue-900/30 border border-blue-500/20 rounded-lg p-4 sm:p-6 backdrop-blur-sm transition-all duration-300 hover:scale-[1.03] hover:bg-blue-800/40 hover:border-blue-400/40 hover:shadow-lg hover:shadow-blue-500/20 group flex flex-col">
                <div>
                  ...
                  <p className="text-sm sm:text-base text-blue-100">
                    Expertise forged in over a decade of focused execution.
                  </p>
                </div>
              </div>
            </StaggeredReveal>
            ...
            <StaggeredReveal delay={240}>
              <div className="h-full bg-blue-900/30 border border-blue-500/20 rounded-lg p-4 sm:p-6 backdrop-blur-sm transition-all duration-300 hover:scale-[1.03] hover:bg-blue-800/40 hover:border-blue-400/40 hover:shadow-lg hover:shadow-blue-500/20 group flex flex-col">
                <div>
                  ...
                  <p className="text-sm sm:text-base text-blue-100">
                    Global benchmarks. Verified compliance. Consistent quality.
                  </p>
                </div>
              </div>
            </StaggeredReveal>
      ...
      <section className="py-10 sm:py-16 md:py-20 bg-gradient-to-b from-black to-secondary/5">
        <div className="container mx-auto px-4">
          <StaggeredReveal delay={80}>
            <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-center mb-2 sm:mb-3 md:mb-4">
              Trusted by Industry Leaders
            </h2>
          </StaggeredReveal>

          <StaggeredReveal delay={160}>
            <p className="text-sm sm:text-base text-gray-400 text-center mb-6 sm:mb-10 md:mb-14 max-w-4xl mx-auto md:whitespace-nowrap overflow-hidden text-ellipsis">
              Selected by Leaders. Trusted for Delivery. Partnerships built on
      ...
      <section className="py-10 sm:py-16 md:py-20 bg-gradient-to-b from-black to-secondary/10">
        <div className="container mx-auto px-4">
          ...
          <StaggeredReveal delay={160}>
            <p className="text-sm sm:text-base text-gray-400 text-center mb-6 sm:mb-8 md:mb-12 max-w-2xl mx-auto">
              Learn more about South Glass and discover what makes us a leader
              in the industry
            </p>
          </StaggeredReveal>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6 md:gap-8 items-stretch">
            {/* Box 1 */}
            <StaggeredReveal delay={0}>
              <div className="h-full glass-card group relative p-4 sm:p-6 md:p-8 rounded-lg transition-all duration-300 overflow-hidden hover:scale-[1.03]">
                <img
                  src="/Icons/history.png"
                  alt="History Icon"
                  className="h-10 w-10 sm:h-12 sm:w-12 md:h-14 md:w-14 text-white mb-3 sm:mb-4 transition-transform duration-300 group-hover:scale-110"
                />
                <h3 className="text-base sm:text-lg md:text-xl font-semibold mb-2 sm:mb-3 text-white">
                  Our History
                </h3>
                <p className="text-sm sm:text-base text-blue-100 mb-4 sm:mb-5">
                  Since 2014, building on the legacy of Prakash Glass & Rubber
                  Works established in 2000.
                </p>
                <Link
                  href="/about"
                  className="glass-button inline-flex items-center text-white px-4 sm:px-5 py-1.5 sm:py-2 rounded-lg transition-all duration-300 group-hover:translate-x-1 text-sm sm:text-base"
                >
            ...
            <StaggeredReveal delay={120}>
              <div className="h-full glass-card group relative p-4 sm:p-6 md:p-8 rounded-lg transition-all duration-300 overflow-hidden hover:scale-[1.03]">
                ...
                <p className="text-sm sm:text-base text-blue-100 mb-4 sm:mb-5">
                  Premium glass solutions for automotive and architectural
                  applications.
                </p>
                <Link
                  href="/products"
            ...
            {/* Box 3 */}
            <StaggeredReveal delay={240}>
              <div className="h-full glass-card group relative p-4 sm:p-6 md:p-8 rounded-lg transition-all duration-300 overflow-hidden sm:col-span-2 md:col-span-1 hover:scale-[1.03]">
                <Building2 className="h-8 w-8 text-white mb-3 sm:mb-4 transition-transform duration-300 group-hover:scale-110" />
                <h3 className="text-base sm:text-lg md:text-xl font-semibold mb-2 sm:mb-3 text-white">
                  Our Projects
                </h3>
                <p className="text-sm sm:text-base text-blue-100 mb-4 sm:mb-5">
                  Showcasing our finest work and notable installations across
                  the country.
                </p>
                <Link
                  href="/projects"
